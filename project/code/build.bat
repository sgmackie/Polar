...
:: -Zi              generate debugging info to .pdb file
...
:: -Fe              to set .exe name
set CompilerFlags=-Zi -FC -MTd -Od -Oi -GR -EHa -WX -W4 -wd4201 -Fo%ObjDir% -DWIN32=1 -DDEBUG -DDEBUG_CRT=1 -DDEBUG_WIN32=0 -DWIN32_METRICS=1 -DPOLAR_LOOP=1 -Fe"polar.exe"
