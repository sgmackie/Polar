...
set CompilerFlags=-Z7 -FC -MTd -Od -Oi -GR -EHa -WX -W4 -wd4201 -Fo%ObjDir% -Fm%MapDir% -DWIN32_METRICS=1 -DWASAPI_INFO=1
...
cl %CompilerFlags% %MainFiles% -LD %LinkerFlags% -PDB:polar_%random%.pdb -EXPORT:RenderUpdate

:: Win32:
cl %CompilerFlags% %PlatformFiles% %LinkerFlags% %Libs%
