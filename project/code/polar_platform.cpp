...
WASAPI_DATA *polar_WASAPI_Create(POLAR_BUFFER &Buffer, u32 UserSampleRate, u16 UserBitRate, u16 UserChannels)
{	
...
void polar_WASAPI_BufferGet(WASAPI_DATA *WASAPI, POLAR_BUFFER &Buffer)
{
...
void polar_WASAPI_BufferRelease(WASAPI_DATA *WASAPI, POLAR_BUFFER &Buffer)
{
	if(WASAPI->DeviceState == Playing)
	{
