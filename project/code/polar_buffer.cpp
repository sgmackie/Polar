...
POLAR_RINGBUFFER *polar_ringbuffer_Create(MEMORY_ARENA *Arena, u32 Samples, u32 Blocks)
{
    ...
    Result->Data = (i16 *) memory_arena_Push(Arena, Result->Data, ((sizeof (*Result->Data)) * (Result->Samples * Result->TotalBlocks)));
...
i16 *polar_ringbuffer_WriteData(POLAR_RINGBUFFER *Buffer)
{
...
i16 *polar_ringbuffer_ReadData(POLAR_RINGBUFFER *Buffer)
{
